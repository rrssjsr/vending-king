...
export default function Home() {
  ...
  const skus = [
    ...
    { name: 'Lay’s Classic 52g', mrp: 20, campusPrice: 30 },
    { name: 'Kurkure 50g', mrp: 20, campusPrice: 30 },
    { name: 'Dairy Milk 24g', mrp: 20, campusPrice: 30 },
  ...
  return (
    <>
      <Head>
        <title>CampusVends — NMIMS ASMSOC Vending</title>
        <meta name="description" content="Snacks & beverages on your floor. UPI/prepaid card, no exits, no queues. Student‑voted SKUs." />
        <meta property="og:title" content="CampusVends — NMIMS ASMSOC Vending" />
        <meta property="og:description" content="Smart, on‑floor vending with fast checkout and student‑first rewards." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://vending-king-y37a.vercel.app/" />
      ...
      <main className="min-h-screen bg-neutral-950 text-neutral-100">
          ...
          <div className="rounded-3xl bg-gradient-to-tr from-emerald-600/20 to-blue-600/20 border border-neutral-800 p-6 md:p-10">
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                ...
                <form action="https://formspree.io/f/xeozvlgv" method="POST" className="mt-6 flex gap-3">
                  <input
                    type="email"
                    name="email"
                ...
                <p className="mt-3 text-xs text-neutral-400">We’ll never share your email. Used only to coordinate the pilot.</p>
              </div>
        ...
        <footer className="border-t border-neutral-800/80 py-10 text-center text-xs text-neutral-500">
          © {new Date().getFullYear()} CampusVends • Founder: Saksham Shukla • Mumbai
        </footer>
      </main>
    </>
  );
